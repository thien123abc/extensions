                  ...
                  <div className="his-chat">
                    ...
                    >
                      {actionState && actionState.id === item.id ? (
                        ...
                        <p className="titles-item-his-view">{item.title}</p>
                      )}
                    ...
                    >
                      <Tippy content="Chỉnh sửa" interactive>
                        <img
                          ...
                          src={EditIcon}
                          alt="edit-icon"
                          onClick={() => setActionState({ id: item.id, type: 'EDIT', text: item.title })}
                        />
                      </Tippy>
                      <Tippy content="Xóa" interactive>
                        <img
                          ...
                          src={DeleteIcon}
                          alt="delete-icon"
                          onClick={() => setActionState({ id: item.id, type: 'DELETE', text: item.title })}
                        />
                      </Tippy>
                    </div>
                    <div
                      className="action-container"
                      style={{ display: actionState?.type === 'EDIT' && actionState.id === item.id ? 'flex' : 'none' }}
                    >
                      <div className="character-display">
                        <Typography variant="body2" color="HighlightText">
                          {titles.find((item2) => item2.id === item.id)?.text.length}/{MAX_CHAR_LENGTH}
                        </Typography>
                      </div>
